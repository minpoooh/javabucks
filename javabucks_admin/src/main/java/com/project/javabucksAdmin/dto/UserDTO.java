...
public class UserDTO {
	...
	public String getUserGradedate() {
		return userGradedate;
	}

	public void setUserGradedate(String userGradedate) {
		this.userGradedate = userGradedate;
	}
	...
	public String getUserFrequencyCount() {
