...
<jsp:include page="../admin_top.jsp"/>
	<!-- s: content -->
    <section id="admin_addmd" class="content addmenu_cont">
        <div class="inner_wrap">
            ...
            <div class="insert_box bg_beige">
                <form name="add_form" action="admin_addmd" method="post" enctype="multipart/form-data">
                													<!-- 파일 전송시 필수작성 -->
                    <div class="info_box">
...
<script type="text/javascript">
	...
	function updateMenuOpt() {
	    let mdDivide = $("select[name='menu_divide']").val();
	    let mdName = $("input[name='menuCode']").val();
	    let mdCode = $("input[name='menu_namecode']").val().toUpperCase();
	
	    let mdOptCodes = mdDivide + "NN";
	    let mdCodes = 'M'+ mdOptCodes + mdCode;
	    
	    $("input[name='menuoptCode']").val(mdOptCodes);
	    $("input[name='menuCode']").val(mdCodes);
	    
	    // 메뉴옵션코드
	    mdCodes = $("input[name='menuoptCode']").val();
	    // 메뉴코드
	    mdCodes = $("input[name='menuCode']").val();
	}
